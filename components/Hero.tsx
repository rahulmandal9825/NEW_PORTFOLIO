...
const Hero = () => {
    return (
        <Section
            className="pt-[75px] relative overflow-clip -mt-[3.25rem] bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] "
            crosses
        ...
        >
            <div className=" flex flex-col container relative md:flex-row mx-auto mt-10 ">
                ...
                <div className="flex flex-col  relative z-1 mx-auto  mb-[4rem] mt-10 text-center md:text-start  lg:mb:[6rem] lg:w-[50%] text-[20px] gap-6 font-semibold text-zinc-300 md:mt-5 ">
                    <span className="inline-block relative  text-zinc-50 text-[30px] ">
                        Rahul Raslal Mandal{" "}
                        <Image
                            src="/hero/curve.png"
